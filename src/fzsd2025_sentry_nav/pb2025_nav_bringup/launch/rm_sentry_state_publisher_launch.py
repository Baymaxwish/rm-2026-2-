...
def generate_launch_description():
    ...
    pkg_fzsd2025_robot_description_dir = get_package_share_directory(
        "fzsd2025_robot_description"
    )
    ...
    declare_robot_name_cmd = DeclareLaunchArgument(
        "robot_name",
        default_value="fzsd2025_sentry_robot",
        ...
        [
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    os.path.join(
                        pkg_fzsd2025_robot_description_dir,
                        "launch",
